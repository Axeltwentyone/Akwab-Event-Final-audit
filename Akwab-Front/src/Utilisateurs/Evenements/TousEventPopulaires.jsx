    ...
    return (
        ...
        <HeaderLayout>
            ...
            <div className="min-h-screen pb-24">
                ...
                <div className="px-4 pt-6 pb-4 my-8 sticky 
                    ...
                    <h1 className="text-xl font-bold text-[#253C96]">
                        Tous les événements populaires
                    </h1>
                </div>
                ...
                {!loading && page >= dernierePage && evenements.length > 0 && (
                    <p className="text-center text-xs text-gray-400 mt-6">
                        Vous avez vu tous les événements populaires
                    </p>
                )}
            </div>
...
export default TousEventPopulaires;